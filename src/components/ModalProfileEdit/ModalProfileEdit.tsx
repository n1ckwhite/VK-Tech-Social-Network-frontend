...
export const ModalProfileEdit: FC<IModalEditProfile> = ({
  data,
  isActive,
  closeModal,
}) => {
      ...
      <div className={styleModalProfileEdit.modal}>
        ...
        <form onSubmit={editProfile}>
          ...
          <Input
            ...
            type="url"
            id="img"
            placeholder="https://4lapy.ru/resize/1664x1000/upload/medialibrary/270/2703fd71a17c0843c0b91bbe28c4fe0f.jpg"
          />
          ...
          <Input
            ...
            type="text"
            id="descr"
            placeholder="Я React Разработчик"
          />
