...
export const ModalConfirm: FC<IModalConfirmAndEditPost> = ({isActive,closeModal,id}) => {
    ...
    return (
        <Modal isActive={isActive} closeModal={closeModal}>
            <div className={styleModalConfrim.modal}>
                ...
                <Button onclick={deletePost} classname={styleModalConfrim.access} text="Подтвердить"/>
                <Button onclick={closeModal} classname={styleModalConfrim.btn} text="Отменить"/>
            </div>
        </Modal>
    )
}